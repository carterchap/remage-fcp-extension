...
InitialiseEnergyLossProcess(const G4ParticleDefinition* part,
  ...
  FCPBetheBlochModel* theModel = new FCPBetheBlochModel(theParticle,"FCPBetheBlochModel");
  ...
  G4VEmFluctuationModel* theFluct = new G4UniversalFluctuation();
  AddEmModel(0,theModel,theFluct, Region);
  isInitialised = true;
}
